...
set import_netlists     ""
lappend import_netlists "${data_dir}/fft_multimode.v"

### SDC files (to be added)

### UPF files
# set golden_upf "${data_dir}/fft_multimode.upf"

### tech files
set synopsys_tech_tf "${lib_dir}/tech/icc2/saed32nm_1p9m_mw.v10.tf"

### scandef
# set scandef_file "${data_dir}/fft_multimode.scandef"
